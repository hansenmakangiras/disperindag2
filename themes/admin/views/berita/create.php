                        ...
                        <div class="panel-body">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 100%; height: auto;" data-trigger="fileinput">
                                    <img src="<?php Yii::app()->theme->baseUrl;?>/assets/images/blank.png" alt="...">
                                </div>
...
<script src='<?php echo Yii::app()->theme->baseUrl ?>/assets/libs/ckeditor-full/ckeditor.js'></script>
<script src='<?php echo Yii::app()->theme->baseUrl ?>/assets/libs/js/fileinput.js'></script>
