...
<div class="breadcrumb">
    <div class="container">
        ...
        &nbsp;&nbsp;/&nbsp;&nbsp;
        <a href="site/about">Tentang Kami</a>
        &nbsp;&nbsp;/&nbsp;&nbsp;
        <b>Visi Misi</b>
    </div>
</div>
...
<div id="page-content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <img src="<?php echo Yii::app()->theme->baseUrl;?>/assets/img/page/makassar_disperindag.png" alt="">
                <p>
            ...
            <div class="col-md-4">
                <ul class="list-unstyled link-accordion">
                    <li><a href="site/about">Visi Misi</a></li>
                    <li><a href="site/about" class="active">Sejarah Kota Makassar</a></li>
                    <li><a href="site/about">Struktur Organisasi</a></li>
                    <li><a href="site/about">Arti Lambang</a></li>
                </ul>
            </div>
        </div>
    </div>
