    ...
    <div class="row">
        ...
        <div class="col-md-6 layanan-item layanan-item-2">
            <div class="col-xs-offset-2 col-md-8">
                ...
                <a href="site/contact">Hubungi Kami &nbsp;<i class="fa fa-long-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
            ...
            <?php for ($i = 1; $i <= 8; $i++) { ?>
                <div class="col-sm-6 col-md-3 no-padding col">
                    <a href="gallery-item.php">
                        <img src="<?php echo yii::app()->theme->baseUrl ?>/assets/img/gallery/post-<?php echo $i ?>.jpg" alt="">
                    </a>
                </div>
            <?php } ?>
        </div>
        ...
        <div class="container">
            <div class="news-items">
                    ...
                    <div class="col-md-6 col item">
                        <div class="col-md-5">
                            <div class="img" style="background: url(<?php echo yii::app()->theme->baseUrl ?>/assets/img/gallery/post-<?php echo $i ?>.jpg)"></div>
                        </div>
                        <div class="col-md-7">
